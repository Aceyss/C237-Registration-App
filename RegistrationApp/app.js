...
app.use(session({
    ...
    // Session expires after 1week of inactivity
...
const validateRegistration =(req, res, next) => {
    ...
    next(); // If all validation pass, the next function is called, allowing the request to process to the next middleware function or route handler
}
